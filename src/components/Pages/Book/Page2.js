...
import { BotonSiguiente, BotonVolver, CajaRecla1,MenajeError } from "../../ElementForm.js";
...
export const Reclamos2 = () => {
    ...
    const expresiones = {
        ...
        descrip: /^[a-zA-ZA-ÿ\s]{1,40}$/, // Letrasyespacios,pueden llevar acentos.
                ...
                <Descrip 
                    ...
                    <CajaRecla1 >
                        <div className="botonVolver">
                            <BotonVolver><a href="javascript: history.go(-1)">Volver</a></BotonVolver>
                        </div>
                        <br />
                        <div className="botonEnviar">
                            <BotonSiguiente type="submit"><a href="/LibroReclamos">Siguiente</a></BotonSiguiente>
                        </div>
                    </CajaRecla1>
                    <br /> <br />
                    </div>
